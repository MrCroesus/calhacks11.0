...
//    var collisionKey = hash1 + "_" + hash2;
    ...
    script.confirmOption1.text = "Merge " + branch_small + "/" + hash_small.slice(0, 4) + " into " + branch_large + "/" + hash_large.slice(0, 4);
    script.confirmOption2.text = "Merge " + branch_large + "/" + hash_large.slice(0, 4) + " into " + branch_small + "/" + hash_small.slice(0, 4);
